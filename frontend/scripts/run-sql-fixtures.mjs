...
const fixtures = [
  ...
  {
    label: "Workbook relationship source-review metadata preservation",
    modulePath: "/src/features/workbook/__tests__/workbookRelationshipSourceReviewMetadata.test.ts",
    exportName: "runWorkbookRelationshipSourceReviewMetadataFixtures",
  },
  {
  ...
  {
    label: "Business SQL plan-element identity",
    modulePath: "/src/features/analyst/sql/__tests__/businessSqlPlanElementIdentity.test.ts",
  ...
  {
    label: "Business SQL date-filter rendering",
    modulePath: "/src/features/analyst/sql/__tests__/businessSqlDateFilterRendering.test.ts",
    exportName: "runBusinessSqlDateFilterRenderingFixtures",
  },
  {
    label: "Business SQL date-range filter contract",
    modulePath: "/src/features/analyst/sql/__tests__/businessSqlDateRangeFilterContract.test.ts",
    exportName: "runBusinessSqlDateRangeFilterContractFixtures",
  },
  {
    label: "Business SQL date-range filter rendering",
    modulePath: "/src/features/analyst/sql/__tests__/businessSqlDateRangeFilterRendering.test.ts",
    exportName: "runBusinessSqlDateRangeFilterRenderingFixtures",
  },
  {
    label: "Business SQL multi-filter contract",
    modulePath: "/src/features/analyst/sql/__tests__/businessSqlMultiFilterContract.test.ts",
