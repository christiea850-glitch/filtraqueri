...
const fixtures: Fixture[] = [
  ...
  { name: "Multiple filters become capable", assert: () => evaluateBusinessSqlRendererCapability(basePlan(null, { filters: [filterFor(), filterFor({ field: "signup_date" })] })).capable ? [] : ["Expected multiple filters capability."] },
