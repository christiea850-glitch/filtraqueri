...
const fixtures: Fixture[] = [
  ...
  { name: "Multiple filters become capable", assert: () => evaluateBusinessSqlRendererCapability(basePlan(null, { filters: [filterFor(), filterFor({ operator: "after" })] })).capable ? [] : ["Expected multiple-filter capability."] },
