...
const BLOCKED_KEYWORD_PATTERNS: Array<{ keyword: string; pattern: RegExp }> = [
  ...
  { keyword: "EXPORT DATABASE", pattern: /\bexport\s+database\b/i },
  { keyword: "IMPORT DATABASE", pattern: /\bimport\s+database\b/i },
  { keyword: "REPLACE", pattern: /\breplace\b/i },
  { keyword: "COPY", pattern: /\bcopy\b/i },
  { keyword: "EXPORT", pattern: /\bexport\b/i },
  { keyword: "GRANT", pattern: /\bgrant\b/i },
  { keyword: "REVOKE", pattern: /\brevoke\b/i },
